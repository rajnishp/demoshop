<?php 
   global $configs;
   $BASE = $configs["CARTATHOME_BASE_URL"];
      ...
      <div class="main">
            ...
            <div class="block module_delivery ">
               <div class="block-content">
                  <div class="delivery a-center">
                     <h1>Grocery, fresh vegetable &amp; fruit delivery made easy</h1>
                     <div class="row no-space">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        	<span class="icon"> 
                        		<img src="<?= $BASE ?>static/media/wysiwyg/icon-order.png" alt="" /> 
                        	</span> 
                        	<strong>order</strong> 
                        	<span class="para-info"> 
                        		Firstly you order what you would like from the website or call us 
                        	</span>
                        	<span class="number">1</span>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        	<span class="icon"> <img src="<?= $BASE ?>static/media/wysiwyg/icon-confirm.png" alt="" /> 
                        	</span> 
                        	<strong>confirm</strong> 
                        	<span class="para-info">We call you to confirm order delivery address and a suitable delivery time.</span> 
                        	<span class="number">2</span>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        	<span class="icon">
                        		<img src="<?= $BASE ?>static/media/wysiwyg/icon-delivery.png" alt="" />
                        	</span> 
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        	<span class="icon">
                        		<img src="<?= $BASE ?>static/media/wysiwyg/icon-pay.png" alt="" />
                        	</span> 
                        	<strong>PAY</strong> 
                        <span class="para-info">Take your bill and pay. </span> 
                  ...
                  <div class="footer-links">
                     <div class="row equal">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-8">
                           <h3>Account</h3>
                           <ul class="l-links">
                              <!-- <li><a title="Wishlist" href="<?= $BASE ?>"><span>Wishlist</span></a></li> -->
                              <li><a title="Your cart" href="<?= $BASE ?>"><span>Your cart</span></a></li>
                              <li><a title="Checkout" href="<?= $BASE ?>"><span>Checkout</span></a></li>
                              <!-- <li><a title="Login" href="<?= $BASE ?>"><span>Login</span></a></li> -->
                           </ul>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-8">
                           <h3>Informations</h3>
                           <ul class="l-links">
                              <li><a title="About us" href="<?= $BASE ?>about.php"><span>About us</span></a></li>
                              <li><a title="Jobs" href="<?= $BASE ?>"><span>Jobs</span></a></li>
                              <li><a title="Sitemap" href="<?= $BASE ?>"><span>Sitemap</span></a></li>
                              <li><a title="Contact" href="<?= $BASE ?>contact.php"><span>Contact</span></a></li>
                           </ul>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-6">
                           ...
                           <ul class="l-links">
                              <li>
                              	...
                              	<span>302, B-3, Genesis, Green Glen layout, Belandor, Bangalore, 560103 <br />India</span> 
                              	<span> +91 - 8040985523 / +91 - 8901414422 .</span>
                              </li>
                              <!-- <li>
                              	<strong>Retail Store</strong> 
                              	<span>54321 Street name, California,<br />USA</span> 
                              	<span>0123 456 789 / 0123 456 788</span>
                              </li> -->
                           </ul>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-8">
                           ...
                           <ul class="l-links l-social">
                              <li>
                              	...
                              	<a title="Facebook" href="<?= $BASE ?>">
                              		<span>Facebook</span>
                              	</a>
                              </li>
                              <li>
                              	<em class="fa fa-twitter"></em>
                              	<a title="Twitter" href="<?= $BASE ?>">
                              		<span>Twitter</span>
                              	</a>
                              </li>
                              <li>
                              	<em class="fa fa-google-plus-square"></em>
                              	<a title="Google+" href="<?= $BASE ?>">
                              		<span>Google+</span>
                              	</a>
                              </li>
                              <li>
                              	<em class="fa fa-youtube"></em>
                              	<a title="Youtube" href="<?= $BASE ?>">
                              		<span>Youtube</span>
                              	</a>
                              </li>
                           </ul>
        ...
        <!--  <div class="footer-bottom">
         ...
         <div id="powered">
            <div class="container">
               <div class="copyright">
                  <address>Copyright 2014 Powered by Dpower4.com All Rights Reserved.</address>
                  Developed By <a href="http://www.Dpower4.com" title="Dpower4">Dpower4.com</a>			
               </div>
         ...
         <section id="before_body_end">
            <div class="banner-bottom-left"><img src="<?= $BASE ?>static/media/wysiwyg/bg-bottom-left.jpg" alt="" /></div>
            <div class="banner-bottom-right"><img src="<?= $BASE ?>static/media/wysiwyg/bg-bottom-right.jpg" alt="" /></div>
         </section>
      </div>
   </div>
</section>
